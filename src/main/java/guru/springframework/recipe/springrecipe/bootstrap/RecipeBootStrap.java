package guru.springframework.recipe.springrecipe.bootstrap;

import guru.springframework.recipe.springrecipe.domain.*;
import guru.springframework.recipe.springrecipe.repositories.CategoryRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        log.debug("received Refreshed Event:{}",contextRefreshedEvent.toString());
    ...
    private List<Recipe> getRecipes(){
        ...
        UnitOfMeasure onceUom = ounceUomOptional.get();
       ...
       //3 guacRecipe.setNotes(guacNotes);
